...
<script src="main2.js?<?php echo time();?>"></script>
...
<div>
	...
	<div class="container">
      ...
      <div class="position-table-box">
        ...
        <div style="float:left;width: 900px;">
          <input type="text" name="usertext" id="usertext" value="" placeholder="Click record button and speak" style="font-size: 20px;display: none;" onclick="return false;" />
  ...
  <div>
	...
	<audio src="recorderjs/file.mp3" id="audioanswer"></audio>
